...
class TokenDeployTransInfo(object):
    ...
    def __init__(self, name=None, code=None, standart=None, state=None, stateTransaction=None,):
        self.name = name
        self.code = code
    ...
    def write(self, oprot):
        ...
        if self.standart is not None:
            oprot.writeFieldBegin('standart', TType.I32, 3)
...
class Transaction(object):
    ...
    def __init__(self, id=None, source=None, target=None, amount=None, balance=None, currency=None, signature=None, smartContract=None, fee=None, timeCreation=None, userFields=None, type=None, smartInfo=None,):
        self.id = id
        self.source = source
        self.target = target
        self.amount = amount
...
class PeriodStats(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i25 in range(_size21):
                        ...
                        _val27 = CumulativeAmount()
                        _val27.read(iprot)
                        self.balancePerCurrency[_key26] = _val27
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.balancePerCurrency is not None:
            ...
            for kiter28, viter29 in self.balancePerCurrency.items():
                oprot.writeByte(kiter28)
                viter29.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class PoolTransactionsGetResult(object):
    ...
    def write(self, oprot):
        ...
        if self.transactions is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.transactions))
            for iter50 in self.transactions:
                iter50.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class SmartContractAddressesListGetResult(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i62 in range(_size58):
                        ...
                        self.addressesList.append(_elem63)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.addressesList is not None:
            ...
            for iter64 in self.addressesList:
...
class SmartContractsListGetResult(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i69 in range(_size65):
                        _elem70 = SmartContract()
                        _elem70.read(iprot)
                        self.smartContractsList.append(_elem70)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.smartContractsList is not None:
            ...
            for iter71 in self.smartContractsList:
                iter71.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TransactionsStateGetResult(object):
    ...
    def write(self, oprot):
        ...
        if self.states is not None:
            ...
            for kiter79, viter80 in self.states.items():
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i85 in range(_size81):
                        _elem86 = general.ttypes.Variant()
                        _elem86.read(iprot)
                        self.params.append(_elem86)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i92 in range(_size88):
                        _elem93 = general.ttypes.MethodDescription()
                        _elem93.read(iprot)
                        self.methods.append(_elem93)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i99 in range(_size95):
                        _elem100 = SmartContractMethodArgument()
                        _elem100.read(iprot)
                        self.arguments.append(_elem100)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class SmartContractDataResult(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i106 in range(_size102):
                        _elem107 = SmartContractMethod()
                        _elem107.read(iprot)
                        self.methods.append(_elem107)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i112 in range(_size108):
                        ...
                        _val114 = general.ttypes.Variant()
                        _val114.read(iprot)
                        self.variables[_key113] = _val114
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.variables is not None:
            ...
            for kiter116, viter117 in self.variables.items():
...
class SmartContractCompileResult(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i122 in range(_size118):
                        _elem123 = general.ttypes.ByteCodeObject()
                        _elem123.read(iprot)
                        self.byteCodeObjects.append(_elem123)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.byteCodeObjects is not None:
            oprot.writeFieldBegin('byteCodeObjects', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.byteCodeObjects))
            for iter124 in self.byteCodeObjects:
                iter124.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i129 in range(_size125):
                        _elem130 = general.ttypes.Variant()
                        _elem130.read(iprot)
                        self.params.append(_elem130)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i136 in range(_size132):
                        _elem137 = TokenBalance()
                        _elem137.read(iprot)
                        self.balances.append(_elem137)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i143 in range(_size139):
                        _elem144 = TokenTransfer()
                        _elem144.read(iprot)
                        self.transfers.append(_elem144)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TokenTransactionsResult(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i150 in range(_size146):
                        _elem151 = TokenTransaction()
                        _elem151.read(iprot)
                        self.transactions.append(_elem151)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.transactions is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.transactions))
            for iter152 in self.transactions:
                iter152.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i157 in range(_size153):
                        _elem158 = TokenHolder()
                        _elem158.read(iprot)
                        self.holders.append(_elem158)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i178 in range(_size174):
                        _elem179 = TrustedInfo()
                        _elem179.read(iprot)
                        self.writers.append(_elem179)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
TokenDeployTransInfo.thrift_spec = (
    ...
    (3, TType.I32, 'standart', None, None, ),  # 3
