...
class ContractAllMethodsGet_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i192 in range(_size188):
                        _elem193 = general.ttypes.ByteCodeObject()
                        _elem193.read(iprot)
                        self.byteCodeObjects.append(_elem193)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.byteCodeObjects is not None:
            ...
            for iter194 in self.byteCodeObjects:
                iter194.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
